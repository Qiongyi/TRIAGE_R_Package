# This Supplementary Data outlines the analysis pipeline for the TRIAGE R package manuscript. To facilitate the reproducibility of our analyses and to ensure that users can fully utilize the TRIAGE R package in various scenarios, we have provided detailed analysis steps below.



#############################################################
######     Figure 1. Overview of the TRIAGE R package  ######
#############################################################
###### For Figure 1, part of the visuals were manually created with BioRender.com and integrated using Adobe Illustrator.
...
###### Source data are listed at "https://github.com/Qiongyi/TRIAGE_R_Package/source_data_scripts_for_paper/Figure2_TRIAGE_prioritized_genes/"

#################
### Figure 2a ### Define the TRIAGE-prioritized genes: elbow point detection based on RTS values in "human_rts_epimap.txt".
#################
...
######################
### Figure 2b & 2c ### Annotation and functional categorization of 993 TRIAGE-prioritized genes
######################
...
# 12) Genereate Figure 2c using custom R codes - see R source codes in "TRIAGE_paper_R_source_code.R"
...
###### Source data are listed at "https://github.com/Qiongyi/TRIAGE_R_Package/source_data_scripts_for_paper/Figure3_TRIAGEgene/GSE95755/"
...
###### Source data are listed at "https://github.com/Qiongyi/TRIAGE_R_Package/source_data_scripts_for_paper/Figure4_TRIAGEcluster/PBMC_ifnb_data/"

# For the in vivo human single-cell RNA-seq data analysis, including scRNA-seq data integration, TRIAGEcluster analysis, and the generation of Figure 4, please refer to the R source code available at "https://github.com/Qiongyi/TRIAGE_R_Package/source_data_scripts_for_paper/TRIAGE_paper_R_source_code.R". A custom Python script ("peak_correlation_and_plot.py" at https://github.com/Qiongyi/TRIAGE_R_Package/source_data_scripts_for_paper/Figure4_TRIAGEcluster) was used to generate Figure 4c.
...
###### Source data are listed at "https://github.com/Qiongyi/TRIAGE_R_Package/source_data_scripts_for_paper/Supplementary_Figure2/"

# For the generation of Supplementary Figure 2, please refer to the R source code available at "https://github.com/Qiongyi/TRIAGE_R_Package/source_data_scripts_for_paper/TRIAGE_paper_R_source_code.R".