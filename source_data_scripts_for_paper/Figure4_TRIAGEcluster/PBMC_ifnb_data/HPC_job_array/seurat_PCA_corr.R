...
for (i in clustnum){
    ...
    immune.combined.sct_1_df <- as.data.frame(t(Embeddings(immune.combined.sct_1, "pca")))
...
saveRDS(dfls.all, paste0("PBMC_ifnb_data/Seurat_PCA_correlation/res_", seures[n], "_PCA_withincluster_mean_correlation.RDS"))
