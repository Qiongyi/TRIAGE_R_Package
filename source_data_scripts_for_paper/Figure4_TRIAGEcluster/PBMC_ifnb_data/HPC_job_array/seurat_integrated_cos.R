...
for (i in clustnum){
    ...
    immune.combined.sct_1_df <- as.matrix(GetAssayData(immune.combined.sct_1, assay = "integrated", slot = "data"))
...
saveRDS(dfls.all, paste0("PBMC_ifnb_data/Seurat_integrated_cosine/res_", seures[n], "_integrated_withincluster_mean_cosine.RDS"))
